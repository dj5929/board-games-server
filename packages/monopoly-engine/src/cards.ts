...
export interface ICard {
  ...
  value?: number; // money amount or position index or backward step
  propertyId?: PropertyId; // specific space to move to
  houseCost?: number;
  hotelCost?: number;
}

export const CHANCE_CARDS: ICard[] = [
  { id: 'chance_advance_go', text: 'Advance to "GO". (Collect $200)', action: 'MOVE_TO_POSITION', propertyId: 'go' as PropertyId, value: 0 },
  { id: 'chance_advance_illinois', text: 'Advance to Illinois Ave. If you pass GO, collect $200.', action: 'MOVE_TO_POSITION', propertyId: 'illinois' as PropertyId, value: 24 },
  { id: 'chance_advance_st_charles', text: 'Advance to St. Charles Place. If you pass GO, collect $200.', action: 'MOVE_TO_POSITION', propertyId: 'st_charles' as PropertyId, value: 11 },
  ...
  { id: 'chance_reading_rr', text: 'Take a trip to Reading Railroad. If you pass GO, collect $200.', action: 'MOVE_TO_POSITION', propertyId: 'reading' as PropertyId, value: 5 },
  { id: 'chance_boardwalk', text: 'Take a walk on the Boardwalk. Advance token to Boardwalk.', action: 'MOVE_TO_POSITION', propertyId: 'boardwalk' as PropertyId, value: 39 },
...
export const COMMUNITY_CHEST_CARDS: ICard[] = [
  { id: 'chest_advance_go', text: 'Advance to "GO". (Collect $200)', action: 'MOVE_TO_POSITION', propertyId: 'go' as PropertyId, value: 0 },
